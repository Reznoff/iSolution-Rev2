...
object DummyData {
    ...
    val jadwalPelajaran = listOf(
            ...
            JadwalPelajaran("Selasa", "IPS", "Drs. Yoyom Maemunah","IX B", "8.30", "10.00", "Ganjil 2018"),
            JadwalPelajaran("Selasa", "IPA", "Elis Sumiyati S.Si", "IX B", "10.40", "12.00", "Ganjil 2018"),
            JadwalPelajaran("Rabu", "Matematika", "Maman Fatman S.T","IX B", "8.30", "10.00", "Ganjil 2018"),
            JadwalPelajaran("Rabu", "IPA", "Elis Sumiyati S.Si", "IX B", "10.00", "12.00", "Ganjil 2018")
    )
